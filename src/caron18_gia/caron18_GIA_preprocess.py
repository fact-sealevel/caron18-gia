...
def caron18_preprocess_GIA(pipeline_id, gia_rate_file: str) -> dict:
    ...
    outdata = {"lats": lats, "lons": lons, "rates": rates, "sds": sds}
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the pre-processing stage for the Caron 18 GIA workflow",
